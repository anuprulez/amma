...
The merged demultiplexed sequencing fasta file can be [here]({{ site.github.repository_url }}/tree/master/data/16s.fna) and corresponding mapping file [here]({{ site.github.repository_url }}/tree/master/data/16s_mapping.txt).
